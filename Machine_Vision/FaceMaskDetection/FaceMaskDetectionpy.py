...
def one_hot_encode(y_train, y_test, label_array, no_of_classes):
    ...
    y_train = utils.to_categorical(y_train_keys, no_of_classes)
    y_test = utils.to_categorical(y_test_keys, no_of_classes)
...
dataset_folder = "./face-mask-dataset2/Dataset/train/"
...
print(labels)
NO_OF_CLASSES = 2     
label_array = {'with_eyesglass':0, 'without_eyesglass':1}
...
save_model_path = "FaceMaskGPU2.h5"
